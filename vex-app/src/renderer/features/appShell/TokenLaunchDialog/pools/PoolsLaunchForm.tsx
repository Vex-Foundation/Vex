        ...
        <div role="radiogroup" aria-label="Paired asset" className="flex gap-1.5">
          {PAIRED_ASSETS.map((asset) => (
            <button
              ...
              className={
                "rounded-full border px-3 py-1 font-doto text-[11px] font-medium uppercase tracking-[0.16em] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary disabled:opacity-50 "
