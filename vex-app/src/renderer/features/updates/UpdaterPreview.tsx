  ...
  return (
    <>
      <div
        ...
        className="fixed bottom-4 right-[21.5rem] z-[70] flex flex-col gap-1 rounded-xl border border-line-3 bg-surface-2 p-2 font-doto text-[10px] uppercase tracking-[0.14em] text-ink-secondary shadow-lv2"
      >
