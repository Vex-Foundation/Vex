...
export const ErrorCodes = {
  ...
  // Indexify (Solana social-index platform on api.indexify.finance — custodial API venue)
  INDEXIFY_API_ERROR: "INDEXIFY_API_ERROR",
  INDEXIFY_TIMEOUT: "INDEXIFY_TIMEOUT",
  INDEXIFY_INVALID_RESPONSE: "INDEXIFY_INVALID_RESPONSE",
  INDEXIFY_INVALID_REQUEST: "INDEXIFY_INVALID_REQUEST",
  INDEXIFY_NOT_FOUND: "INDEXIFY_NOT_FOUND",
  INDEXIFY_AUTH_REQUIRED: "INDEXIFY_AUTH_REQUIRED",
  INDEXIFY_RATE_LIMITED: "INDEXIFY_RATE_LIMITED",

  // Ansem Z500 (ansem.io — read-only ranking feed for the allocation-sync workflow)
  ANSEM_UNAVAILABLE: "ANSEM_UNAVAILABLE",
  ANSEM_INVALID_RESPONSE: "ANSEM_INVALID_RESPONSE",
  ANSEM_STALE: "ANSEM_STALE",
  ANSEM_TIMEOUT: "ANSEM_TIMEOUT",
