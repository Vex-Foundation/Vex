...
/**
 * Upstream provider name from routing metadata (`RouterAttempt.provider`),
 * e.g. `Anthropic`, `Fireworks`. Log-only — never persisted, never a routing
 * decision. `null` when absent or unusable.
 */
