...
export const STUDIO_TOOL_TITLES: Readonly<Record<string, string>> = {
  ...
  dexscreener__pairs_get: "Read one DEX pair",
  dexscreener__tokens_get: "Batch-price tokens on one chain",
  dexscreener__token_pairs_list: "List a token's DEX pools",
  dexscreener__profiles_list: "Read DEX Screener token profiles",
  dexscreener__boosts_list: "Read DEX Screener paid boosts",
  dexscreener__community_takeovers_list: "List community-takeover tokens",
  dexscreener__attention_list: "Rank tokens by DEX Screener attention",
  dexscreener__narratives_list: "List trending DEX Screener narratives",
  dexscreener__narrative_get: "Read one trending narrative",
  dexscreener__token_orders_list: "List a token's paid promotion orders",
  dexscreener__ads_list: "List DEX Screener ad placements",
