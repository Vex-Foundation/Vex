...
export const VIRTUALS_MARKET_DISCOVERY = {
  ...
  "virtuals.candles": {
    embeddingText: embeddingText(
      ...
      + `Example queries: price chart for this virtuals agent, ohlcv candles for the agent token, what was the high and low today, price history before it graduated.`,
    ),
