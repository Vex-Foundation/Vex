...
export const POOLS_LAUNCH_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  },
  {
    ...
    description:
      ...
      + "backend-signed quote the factory honours only for that pair's own quote window - at most 120 seconds and "
      + "often as little as 30 - so such a launch must go through at once and is otherwise refused rather than "
      + "sent to revert; whether such a pool ends up liquid is unknown "
