...
export const POOLS_LAUNCH_FIELD_PARAMS: readonly ProtocolParamDef[] = [
  ...
  },
  {
    ...
    description:
      ...
      + "backend-signed quote that is valid only for its pair's own quote window, which the factory allows to be "
      + "configured between 30 and 120 seconds, so such a launch must be prepared, confirmed and broadcast inside "
      + "that window and is re-prepared automatically if it lapses.",
  },
  {
    key: "holderRewards",
    type: "boolean",
