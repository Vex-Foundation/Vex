...
import { KYBERSWAP_EDGE_BLOCK_GUIDANCE, SWAP_VENUE_GUIDANCE } from "@vex-agent/tools/registry/swap-venue-guidance.js";
...
export const SWAP_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  },
  {
    ...
    description:
      ...
      + `already priced. ${SWAP_VENUE_GUIDANCE} ${KYBERSWAP_EDGE_BLOCK_GUIDANCE} APPROVAL: in a RESTRICTED `
