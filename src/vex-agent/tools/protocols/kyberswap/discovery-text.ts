 ...
 * here so the lexical scorer can recall rare chain names (Plasma, Berachain,
 * Sonic, Monad, etc.) when an agent queries by chain.
 *
...
export const KYBER_SWAP_CHAINS: readonly string[] = [
  ...
  "Unichain", "HyperEVM", "Plasma", "Monad", "MegaETH",
