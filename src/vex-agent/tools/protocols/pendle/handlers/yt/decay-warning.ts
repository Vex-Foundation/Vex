/**
 * The plain-language decay warning every YT surface repeats, so the model always
 * sees the horizon and never frames YT as fixed yield.
 */
export const YT_DECAY_WARNING =
