...
function buildDepositApprovalFollowUp(intent: LighterOnboardingIntentRow): PreparedActionFollowUp {
  ...
  const criticalArgs: Record<string, ApprovalPreviewScalar> = {
    ...
    preflightApproveGasLimit: disclosure.approveGasLimit,
    preflightDepositGasLimit: disclosure.depositGasLimit,
    preflightMaxFeePerGasWei: disclosure.maxFeePerGasWei,
    preflightMaxPriorityFeePerGasWei: disclosure.maxPriorityFeePerGasWei,
    preflightApproveMaxFeeWei: disclosure.approveMaxFeeWei,
    preflightDepositMaxFeeWei: disclosure.depositMaxFeeWei,
    preflightTotalMaxFeeWei: disclosure.totalMaxFeeWei,
    preflightNativeReserveWei: disclosure.nativeReserveWei,
    preflightRequiredNativeBalanceWei: disclosure.requiredNativeBalanceWei,
...
function depositApprovalPreparedPayload(intent: LighterOnboardingIntentRow): Record<string, unknown> {
  ...
  return {
    ...
    settlementTokenAddress: disclosure.settlementTokenAddress,
    maximumNetworkFeeDisplay: disclosure.maximumNetworkFeeDisplay,
    requiredNativeBalanceDisplay: disclosure.requiredNativeBalanceDisplay,
    maxFeePerGasDisplay: disclosure.maxFeePerGasDisplay,
