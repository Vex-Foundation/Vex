...
export const LEND_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "amountRaw", type: "string", required: true, description: "Amount to deposit, in RAW atomic units of the asset as an integer string, never human decimals (e.g. USDC has 6 decimals, so 1 USDC = \"1000000\") — read the asset's decimals from solana.lend.rates' assetDecimals, or from TokenFind, before building it." },
    ],
