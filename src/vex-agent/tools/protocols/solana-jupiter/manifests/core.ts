...
export const CORE_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  },
  {
    ...
    namespace: "solana",
    lifecycle: "active",
    description: "Discover Solana tokens without already knowing a name — freshly launched/new (recent), trending, top-traded, top-organic, verified, tokenized stocks, or liquid staking. Solana's primary token-discovery feed: richer signal (organic score, verification, holder data) than generic feeds for finding new/fresh tokens. Use solana.tokens.search instead once you already have a specific symbol, name, or mint to look up.",
    mutating: false,
    actionKind: "read",
    params: [
