...
export const PREDICT_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  // ── Discovery & social tools (W1-F) ─────────────────────────────
  {
    ...
    namespace: "solana",
    lifecycle: "active",
    description: "Get a trader's aggregate lifetime Jupiter Prediction stats — realized PnL, total volume, win/loss counts — for ANY wallet address, not just your own. Use solana.predict.pnlHistory instead for a PnL time series, or solana.predict.leaderboards to compare against other traders. Money fields (realizedPnlUsd, totalVolumeUsd, totalPositionsValueUsd) are exact-decimal USD strings with raw *Micro siblings.",
    mutating: false,
    actionKind: "read",
    params: [
      { key: "address", type: "string", required: true, description: "Wallet address." },
  ...
  },
  {
    ...
    exampleParams: { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", interval: "1w" },
    requiresEnv: "JUPITER_API_KEY",
  ...
  },
  {
    ...
    namespace: "solana",
    lifecycle: "active",
    description: "Get personalized Jupiter Prediction event recommendations for ANY wallet pubkey (not only your own). Use solana.predict.events/.search instead for an unpersonalized browse/keyword lookup.",
    mutating: false,
    actionKind: "read",
    params: [
      { key: "pubkey", type: "string", required: true, description: "Wallet public key to base recommendations on." },
      { key: "provider", type: "string", description: "Provider: kalshi, polymarket, or bisonfi (Jupiter Forecast). Default polymarket." },
      { key: "includeMarkets", type: "boolean", description: "Include each recommended event's nested markets array (default false — lean)." },
    ],
    exampleParams: { pubkey: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM" },
    requiresEnv: "JUPITER_API_KEY",
