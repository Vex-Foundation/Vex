 ...
 *     read_only.
 *
 *   - `SessionMemoryResolve`: close one outstanding item on a chunk.
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        memory_id: {
          type: "number",
          description: "Session memory chunk id (from SessionMemorySearch output).",
        },
        outstanding_item_id: {
          type: "string",
