...
| BridgeExecute | Execute a cross-chain bridge | internal | no | yes | yes | - | 2046 | yes | 25 bps |
| BridgeExecuteRelay | Execute a Relay bridge | internal | no | yes | yes | - | 1361 | yes | 25 bps |
...
| SwapExecute | Execute a token swap | internal | no | yes | yes | - | 1869 | yes | 25 bps |
| SwapExecuteUniswap | Execute a Uniswap swap | internal | no | yes | yes | - | 1073 | yes | 25 bps |
...
| WalletEvmTransactionConfirm | Broadcast a prepared EVM transaction | internal | no | yes | yes | - | 2025 | yes | 25 bps |
| WalletEvmTransactionPrepare | Prepare an EVM transaction | internal | no | no | yes | - | 2035 | yes | 25 bps |
| WalletSendConfirm | Broadcast a prepared wallet transfer | internal | no | yes | yes | - | 1691 | yes | none |
| WalletSendPrepare | Prepare a wallet transfer | internal | no | no | yes | - | 1342 | yes | none |
| WalletSolanaTransactionConfirm | Broadcast a prepared Solana transaction | internal | no | yes | yes | - | 1568 | yes | none |
| WalletSolanaTransactionPrepare | Prepare a Solana transaction | internal | no | no | yes | - | 1747 | yes | none |
...
| dexscreener__token_pairs_list | List a token's DEX pools | protocol | yes | no | no | - | 3038 | - | - |
...
| name | title | lane | read only | destructive | always load | requires env | description bytes | returns | vex fee |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| khalani__bridge_execute | Execute a Khalani bridge | protocol | no | yes | no | - | 2944 | - | - |
| khalani__bridge_quote_get | Quote a Khalani bridge | protocol | yes | no | no | - | 1944 | - | - |
...
| name | title | lane | read only | destructive | always load | requires env | description bytes | returns | vex fee |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pendle__asset_prices_get | Read Pendle asset prices | protocol | yes | no | no | - | 1249 | - | - |
...
| pendle__market_candles_get | Read Pendle asset price candles | protocol | yes | no | no | - | 1079 | - | - |
| pendle__market_get | Read one Pendle market | protocol | yes | no | no | - | 1057 | - | - |
| pendle__market_history_get | Read a Pendle market's history | protocol | yes | no | no | - | 735 | - | - |
| pendle__market_orderbook_get | Read Pendle limit-order depth | protocol | yes | no | no | - | 1732 | - | - |
| pendle__markets_discover | Screen Pendle yield markets | protocol | yes | no | no | - | 2097 | - | - |
| pendle__merkle_rewards_list | List claimable Pendle merkle rewards | protocol | yes | no | no | - | 1664 | - | - |
...
| relay__bridge_quote_get | Quote a Relay cross-chain bridge | protocol | yes | no | no | - | 1685 | - | - |
...
| trench__launch_preview | Dry-run a Trench Express launch | protocol | yes | no | no | - | 1704 | - | - |
...
| uniswap__swap_quote | Quote a Uniswap V2/V3 route | protocol | yes | no | no | - | 694 | - | - |
