...
| kyberswap__swap_execute | Execute a KyberSwap swap | protocol | no | yes | no | - | 3925 | yes | 25 bps |
| kyberswap__swap_quote | Quote a KyberSwap swap | protocol | yes | no | no | - | 3803 | - | none (read) |
...
| name | title | lane | read only | destructive | always load | requires env | description bytes | returns | vex fee |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| uniswap__swap_execute | Execute a Uniswap V2/V3/v4 swap | protocol | no | yes | no | - | 3694 | yes | 25 bps |
| uniswap__swap_quote | Quote a Uniswap V2/V3/v4 route | protocol | yes | no | no | - | 4954 | - | none (read) |
