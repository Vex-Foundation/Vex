...
| lighter__open_orders_list | List open Lighter orders | protocol | yes | no | no | - | 501 | - | none (read) |
...
| lighter__order_history_list | Read Lighter order history | protocol | yes | no | no | - | 481 | - | none (read) |
...
| lighter__trades_list | Read Lighter account trades | protocol | yes | no | no | - | 520 | - | none (read) |
