-- 100 (098 on its branch, renumbered at integration behind the Studio
-- migrations 097 and 098): the WALLET-ADDRESS access path for the three intent tables the snapshot
