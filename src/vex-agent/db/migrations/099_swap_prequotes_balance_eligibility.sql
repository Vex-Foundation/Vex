-- 099_swap_prequotes_balance_eligibility.sql - a quote that the wallet cannot
-- pay for is a quote that authorizes nothing.
--
-- RUNS AFTER 098 (097 and 098 are the Studio project soft-delete and file
-- provenance migrations that reached main first; this file was 097 on its
-- branch and was renumbered at integration, content unchanged).
--
