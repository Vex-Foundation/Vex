...
When it applies: On Robinhood Chain, quote both venues when both price the pair; prefer direct Uniswap when it has a route (V2/V3 only, no v4). KyberSwap drops quiet pools; its USD reference lags. Elsewhere, KyberSwap is the usual first choice.
