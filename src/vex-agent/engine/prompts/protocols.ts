...
export function buildProtocolsPrompt(): string {
  ...
  lines.push("- For a trade request stated as a USDC amount or 'USDC worth', pass that amount as `amountIn` to onboarding status. This is the requested collateral check, not permission to deposit or trade.");
