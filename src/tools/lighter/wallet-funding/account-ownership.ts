...
/**
 * Resolve the one Core master account owned by a wallet from every paginated
...
export async function readUniqueLighterCoreMasterAccount(
  ...
  if (
    ...
    throw new Error("The selected wallet does not have one uniquely owned Lighter Core master account.");
  }
