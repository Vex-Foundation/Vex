...
| `indexify/` | Indexify social-index stacks — CUSTODIAL API venue (server-side trades on the linked account's USDC, `INDEXIFY_API_KEY`); public discovery reads keyless | Solana | 5 | [Indexify.md](indexify/Indexify.md) |
