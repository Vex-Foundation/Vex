 ...
 *
 * MERGE, main into Lighter-Integration (2026-09-07). Ceilings are the measured
 * `buildPromptStack` byte counts on the merged tree, not a sum of either
 * side's deltas: main's launchpads-arc ceilings above (`59_821` etc.) already
 * net out the Trench Express retirement (migration 108 deletes the Trench card
 * and its two prompt lines), and this branch's own Lighter prompt content adds
 * a flat +827 bytes in every mode on top of that. Measured directly rather
 * than reconciling both change logs by hand.
 *
 *   agent / restricted          59,821 -> 60,648
 *   agent / full                60,522 -> 61,349
 *   mission setup / restricted  66,298 -> 67,125
 *   mission setup / full        66,317 -> 67,144
 *   mission run / restricted    65,022 -> 65,849
 *   mission run / full          64,837 -> 65,664
 */
const MODES = [
